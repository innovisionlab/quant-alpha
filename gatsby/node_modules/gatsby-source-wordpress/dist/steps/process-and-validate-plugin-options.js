...
const optionsProcessors = [{
  ...
  test: ({
    ...
    return !!(userPluginOptions !== null && userPluginOptions !== void 0 && (_userPluginOptions$ty = userPluginOptions.type) !== null && _userPluginOptions$ty !== void 0 && (_userPluginOptions$ty2 = _userPluginOptions$ty.MediaItem) !== null && _userPluginOptions$ty2 !== void 0 && _userPluginOptions$ty2.limit);
  },
  processor: ({
    helpers,
    userPluginOptions
