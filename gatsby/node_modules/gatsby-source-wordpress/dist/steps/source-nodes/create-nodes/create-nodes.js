...
const createNodeWithSideEffects = ({
  ...
  const builtTypename = (0, _helpers.buildTypeName)(node.__typename);
  let remoteNode = { ...node,
  ...
  if (typeof (typeSettings === null || typeSettings === void 0 ? void 0 : typeSettings.beforeChangeNode) === `function`) {
    ...
    if (additionalNodeIds !== null && additionalNodeIds !== void 0 && additionalNodeIds.length && totalSideEffectNodes) {
